...
//                    fs.println(format!("accept from addr: {}", &addr));
...
//                            fs.println("server wrote".to_string());
//                        }
//                    }
...
//                                    fs.println("server received".to_string());
//                                }
//                                _ => continue
//                            }
//                        }
...
//                        fs.println("client wrote".to_string());
//                    }
//                    if event.readiness().is_readable() {
//                        let mut hello = [0; 4];
...
//                                fs.println("client received".to_string());
//                            }
//                            _ => continue
//                        }
//                    }
